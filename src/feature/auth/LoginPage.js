      ...
      <div className="left-section">
        ...
        <ul className="features">
          <li>
            <b>Abhi Assured</b>
            <p>
              Protect yourself with up to 150% refund in case of service
              cancellation
            </p>
          </li>
          <li>
            ...
            <p>
              Protect yourself from cancellation charges and get 100% refund
            </p>
          </li>
          <li>
            <b>4.6* Rating</b>
            <p>
              India's highest-rated bus platform, trusted by 5+ crore happy
              customers
            </p>
          </li>
        </ul>

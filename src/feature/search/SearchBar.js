...
import { fetchTripsList } from "././../trips/thunk"
...
const SearchBar = ({ city }) => {
  ...
  const suggestions = useSelector((state) => state.search.cities.data) || [];
  ...
  const handelSublit = () => {
    ...
    const paraid = {
      sourceCityId : "66edcde90fb34f2607a7c004",
      destinationCityId : "66edcde90fb34f2607a7bffb",  
      travelDate:"1726876800"
    }

    dispatch(fetchTripsList(paraid))
    ...
    <div>
      ...
      {showPopOver.source && (
          <div className="search-city-div">
            {filterCities("source", city, search)
              .length > 0 ? (
              filterCities(
                "source",
                city,
      ...
      <div className="destination-city-div city-div">
        {showPopOver.destination && (
          <div className="search-city-div">
            {filterCities("destination", city, search)
              .length > 0 ? (
              filterCities(
                "destination",
                city,

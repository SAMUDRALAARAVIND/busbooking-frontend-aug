                    ...
                    <div className="trip-details-body">
                      ...
                      <div className="boarding-droping-details">
                        <div className="boarding-point">
                          ...
                          <div>
                            20 Sep 2024,
                            <span class="departure-time time">18:10</span>
                          </div>
                        ...
                        <div className="droping-point">
                          ...
                          <div>
                            21 Sep 2024,
                            <span class="departure-time time">08:35</span>
                          </div>
                  ...
                  children: (
                    <div className="Passenger-Details-body">
                      <div className="Add-Passenger">
                        Add Passenger for :{" "}
                        <span class="text-success"> 4UC</span>
                      </div>
                      ...
                      <div className="add-details">
                        ...
                        <div className="gemder-wrraper">
                          <button className="gender-option">Male</button>
                          <button className="gender-option">Female</button>
                        </div>
                      </div>
